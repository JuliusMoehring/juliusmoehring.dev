...
export type SocialIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;

export const TwitterIcon: Component<SocialIconProps> = ({ ...attributes }) => {
    return (
...
export const GitHubIcon: Component<SocialIconProps> = ({ ...attributes }) => {
    return (
        <svg viewBox="0 0 24 24" aria-hidden="true" {...attributes}>
            <path
                fill-rule="evenodd"
...
export const LinkedInIcon: Component<SocialIconProps> = ({ ...attributes }) => {
    return (
        <svg viewBox="0 0 24 24" aria-hidden="true" {...attributes}>
...
export const DataCampIcon: Component<SocialIconProps> = ({ ...attributes }) => {
    return (
        <svg viewBox="0 0 24 24" aria-hidden="true" {...attributes}>
